...
from .models import Admin, MayorsPermit, IDCard, Mtop, Franchise, MayorsPermitTricycle, SuperAdmin, AdminPermission, MayorsPermitHistory, MayorsPermitTricycleHistory, ActivityLog, Task, Tricycle, TricycleHistory
